...
class RecordingsView(QWidget):
    def __init__(self,directory,parent=None,language="en"):
        ...
        self.search.setToolTip(self.t("tip.player_search"))
        self.sort.setToolTip(self.t("tip.player_sort"))
        self.list.setToolTip(self.t("tip.player_list"))
        self.timeline.setToolTip(self.t("tip.player_timeline"))
        self.volume.setToolTip(self.t("tip.player_volume"))
        self.speed.setToolTip(self.t("tip.player_speed"))
