...
Текущая версия — **0.9.4**. [Изменения](CHANGELOG.md) · [Инструкции релиза](RELEASE.md).
...
**Публикация в GitHub, магазины расширений и внешние сервисы запрещена без отдельной прямой команды пользователя.** Выпуски 0.9.2, 0.9.3 и 0.9.4 опубликованы в GitHub по прямой команде пользователя.
...
Версия 0.9.4 выпускается двумя Windows-профилями; сборки выполняются командами build_modern/build_legacy и располагаются в отдельных каталогах `dist/modern` и `dist/legacy`. Готовые EXE публикуются как GitHub Release assets, не в истории Git.
