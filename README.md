...
Текущая версия — **0.4.0**. [Изменения](CHANGELOG.md) · [Инструкции релиза](RELEASE.md).
Локальный комплект: `releases/0.4.0/` — EXE, ZIP приложения, исходники, manifest.json и SHA256SUMS.txt.
