...
Скрытие ScreenRec не останавливает запись. Универсальный захват свёрнутых окон не поддерживается. Курсор, плеер, автозапуск и файловые логи ещё не реализованы.
...
Текущая версия — **0.5.0**. [Изменения](CHANGELOG.md) · [Инструкции релиза](RELEASE.md).
Локальный комплект: `releases/0.5.0/` — EXE, ZIP приложения, исходники, manifest.json и SHA256SUMS.txt.
