...
Приложение записи экрана на Python / PySide6. Реализован этап 1, дополненный конфигуратором, звуком и сборкой в один EXE по требованиям пользователя.
...
Записывается содержимое монитора, включая видимые окна. Скрытие **ScreenRec** не останавливает
запись. Захват свёрнутого чужого окна, отдельных окон/вкладок и областей относится к этапу 2.
Захват рабочего стола не позволяет видеть содержимое свёрнутых окон. Курсор,
темы, плеер, водяные знаки, автозапуск и файловые логи ещё не реализованы.
...
Проверено на Windows, Python 3.13.14: 9 автотестов, включая 9 сочетаний формата/качества,
...
Текущая версия — **0.2.0**. [Изменения](CHANGELOG.md) · [Инструкции релиза](RELEASE.md).
Локальный комплект: `releases/0.2.0/` — EXE, ZIP приложения, исходники, manifest.json и SHA256SUMS.txt.
