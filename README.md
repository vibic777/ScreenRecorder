...
Скрытие ScreenRec не останавливает запись. Универсальный захват свёрнутых окон не поддерживается. Курсор, плеер и автозапуск ещё не реализованы.
...
Текущая версия — **0.6.0**. [Изменения](CHANGELOG.md) · [Инструкции релиза](RELEASE.md).
Локальный комплект: `releases/0.6.0/` — EXE, ZIP приложения, исходники, manifest.json и SHA256SUMS.txt.
